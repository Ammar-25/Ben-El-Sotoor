    ...
    host.innerHTML = `
      <nav class="container" aria-label="Main">
        ...
        <div class="nav-actions">
          <a class="icon-btn" href="search.html" aria-label="${I18N.t('nav.search')}" title="${I18N.t('nav.search')}">${icon.search}</a>
          ...
          <a class="icon-btn desktop-only" href="profile.html" aria-label="${I18N.t('nav.profile')}" title="${I18N.t('nav.profile')}">${icon.user}<span class="count-bubble" data-fav-count></span></a>
      ...
      <div class="container">
        <div class="footer-grid">
          ...
          <div class="footer-col">
            ...
            <ul>${link('library.html', 'nav.library')}${link('categories.html', 'nav.categories')}${link('authors.html', 'nav.authors')}${link('subscriptions.html', 'nav.subscriptions')}</ul>
          </div>
          <div class="footer-col">
            <h3 data-i18n="footer.support">${I18N.t('footer.support')}</h3>
            <ul>${link('#', 'footer.contact')}${link('subscriptions.html', 'footer.faq')}${link('#', 'footer.privacy')}${link('#', 'footer.terms')}</ul>
          </div>
          <div class="footer-col">
            <h3 data-i18n="footer.followUs">${I18N.t('footer.followUs')}</h3>
            <ul>${link('quiz.html', 'nav.quiz')}${link('reviews.html', 'nav.reviews')}${link('login.html', 'nav.login')}</ul>
          </div>
        </div>
    ...
    card.innerHTML = `
      <div class="book-cover">
        ...
        <div class="book-actions">
          ...
          <button class="icon-btn" data-add="${book.id}" aria-label="${I18N.t('common.addToCart')}" title="${I18N.t('common.addToCart')}">${icon.cart}</button>
        </div>
      </div>
      <div class="book-body">
    ...
    m.querySelector('.modal-content').innerHTML = `
      <div class="modal-body">
        ...
        <div class="modal-info">
          ...
          <div class="modal-cta">
            <button class="btn btn-primary" data-add="${book.id}" data-i18n="common.addToCart">${I18N.t('common.addToCart')}</button>
            <button class="btn btn-ghost" data-i18n="common.readSample">${I18N.t('common.readSample')}</button>
          </div>
        </div>
      </div>`;
